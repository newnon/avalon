...
import com.avalon.payment.PurchasingObserverAmazon;

public class BackendAmazon
{
    private static PurchasingObserverAmazon mPurchaseObserver = null;
    ...
    {
        if (!isInitialized()) {
            mPurchaseObserver = new PurchasingObserverAmazon();
        }
    }
