...
import com.avalon.payment.PurchasingObserverGoogle;

public class BackendGoogle
{
    private static PurchasingObserverGoogle mPurchaseObserver = null;
    ...
    {
        if (!isInitialized()) {
            mPurchaseObserver = new PurchasingObserverGoogle();
        }
    }
    ...
    {
    	PurchasingObserverGoogle.base64EncodedPublicKey = publicKey;
    }
}
