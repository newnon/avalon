...
import com.avalon.payment.BackendAmazon;
 ...
 */
public class PurchasingObserverAmazon extends BasePurchasingObserver
{
     ...
     */
    public PurchasingObserverAmazon()
    {
    ...
    public void purchase(String productId, boolean isConsumable)
    {
        if (++taskCount == 1) {
            Cocos2dxHelper.runOnGLThread(new Runnable() {
                public void run() {
                    BackendAmazon.delegateOnTransactionStart();
                }
            });
        }
    ...
    public void sendStoresProductsAndStartService()
    {
        Cocos2dxHelper.runOnGLThread(new Runnable() {
            public void run() {
            	BackendAmazon.delegateOnServiceStarted();
            }
        });
        ...
        for (final Map.Entry<String,?> entry : getSharedPreferencesForCurrentUser().getAll().entrySet()) {
            ...
            Cocos2dxHelper.runOnGLThread(new Runnable() {
                public void run() {
                	BackendAmazon.delegateOnPurchaseSucceed(entry.getKey());
                }
            });
        }
            ...
            switch (itemDataResponse.getItemDataRequestStatus()) {
                case SUCCESSFUL_WITH_UNAVAILABLE_SKUS:
                    ...
                    for (final String s : itemDataResponse.getUnavailableSkus()) {
                        ...
                        Cocos2dxHelper.runOnGLThread(new Runnable() {
                            public void run() {
                            	BackendAmazon.delegateOnItemData(s, "", "", "", 0.0f);
                            }
                        });
                    }
                ...
                case SUCCESSFUL:
                    ...
                    for (final String key : items.keySet()) {
                        ...
                        Cocos2dxHelper.runOnGLThread(new Runnable() {
                            public void run() {
                            	BackendAmazon.delegateOnItemData(key, i.getTitle(), i.getDescription(), i.getPrice(), 0.0f);
                            }
                        });
                    }
                    return true;
    ...
    private class PurchaseAsyncTask extends AsyncTask<PurchaseResponse, Void, Boolean>
    {
        ...
        protected Boolean doInBackground(final PurchaseResponse... params)
        {
            ...
            switch (purchaseResponse.getPurchaseRequestStatus()) {
                case SUCCESSFUL:
                    ...
                    Cocos2dxHelper.runOnGLThread(new Runnable() {
                        public void run() {
                        	BackendAmazon.delegateOnPurchaseSucceed(receipt.getSku());
                        }
                    });
                ...
                case ALREADY_ENTITLED:
                    ...
                    Cocos2dxHelper.runOnGLThread(new Runnable() {
                        public void run() {
                        	BackendAmazon.delegateOnPurchaseSucceed(sku);
                        }
                    });
                ...
                case FAILED:
                    ...
                    Cocos2dxHelper.runOnGLThread(new Runnable() {
                        public void run() {
                        	BackendAmazon.delegateOnPurchaseFail();
                        }
                    });
        ...
        protected void onPostExecute(final Boolean success)
        {
            ...
            if (--taskCount == 0) {
                Cocos2dxHelper.runOnGLThread(new Runnable() {
                    public void run() {
                    	BackendAmazon.delegateOnTransactionEnd();
                    }
                });
            }
        }
